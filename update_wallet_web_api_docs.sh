...
nix-shell -p nodejs-7_x --run "npm install bootprint"
nix-shell -p nodejs-7_x --run "npm install bootprint-openapi"
nix-shell -p nodejs-7_x --run "npm install html-inline"
